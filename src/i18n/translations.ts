...
const de = {
  ...
  'remote.controllerTitle': 'Fernsteuerung',
  'remote.generating': 'QR-Code wird erstellt',
  'remote.scanQR': 'Scanne diesen QR-Code mit deinem Smartphone, um die Fernsteuerung zu starten.',
  'remote.copyOffer': 'Code kopieren',
  'remote.pasteAnswer': 'Antwort-Code vom Controller einfügen:',
  'remote.answerPlaceholder': 'Antwort-Code',
  'remote.paste': 'Einfügen',
  'remote.connect': 'Verbinden',
  'remote.connected': 'Verbunden!',
  'remote.connectedHint': 'Die Fernsteuerung ist aktiv. Du kannst dieses Fenster schließen.',
  'remote.connecting': 'Verbinde',
  'remote.showAnswerQR': 'Zeige diesen QR-Code dem Hauptbildschirm oder kopiere den Code.',
  'remote.copyAnswer': 'Antwort-Code kopieren',
...
const en: Record<TranslationKey, string> = {
  ...
  'remote.controllerTitle': 'Remote Control',
  'remote.generating': 'Generating QR code',
  'remote.scanQR': 'Scan this QR code with your smartphone to start the remote control.',
  'remote.copyOffer': 'Copy code',
  'remote.pasteAnswer': 'Paste the answer code from the controller:',
  'remote.answerPlaceholder': 'Answer code',
  'remote.paste': 'Paste',
  'remote.connect': 'Connect',
  'remote.connected': 'Connected!',
  'remote.connectedHint': 'The remote control is active. You can close this window.',
  'remote.connecting': 'Connecting',
  'remote.showAnswerQR': 'Show this QR code to the main screen or copy the code.',
  'remote.copyAnswer': 'Copy answer code',
